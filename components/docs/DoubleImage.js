export default function DoubleImage(props) {
    return (
        <div className="row m-t-40">
            <div className="pinciple-do xs-col-1-1 sm-col-1-1 md-col-1-2 lg-col-1-2 xl-col-1-2">
            ...
            <div className="pinciple-dont xs-col-1-1 sm-col-1-1 md-col-1-2 lg-col-1-2 xl-col-1-2">
