...
export default function DetailCard(props) {
    ...
    return (
        <a href={props.link} className="m-x-5 m-y-15 br-lg overflow-hidden shadow-2" style={{ display: 'block' }}>
            <div className="h-40 bg-no-repeat bg-size-contain has-bg-brand-300" style={{ height: "300px", backgroundPosition: 'top center', backgroundImage: `url("${props.image}")` }}></div>
            {props.items
