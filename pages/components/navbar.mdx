...
<div className="row">
  ...
  <ResourceCard name="Ember" icon="ember" caption="Avaiable Now" link="https://denali-design.github.io/denali-ember/?path=/story/denali-ember-denalinavbar--playground" />
  <ResourceCard name="React" icon="react" caption="Avaiable Now" link="https://denali-design.github.io/denali-react/?path=/story/components-dnnavbar--playground" />
</div>
