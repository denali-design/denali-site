...
<CodeBox
  height="600px"
  source={`
    <div class="has-bg-grey-100 p-20" style="height:600px;">
     <div class="row br-6 overflow-hidden" style="height:446px;">
         <div class="box bg-size-cover col-1-2 p-x-57 p-t-100" style="background-image: url('/images/play/hero/hero-1.png');
        ...
        <div class="box col-1-2 p-x-40 p-y-50" style="border-radius:0; border: none;">
            <h2> Sign Up </h2>
